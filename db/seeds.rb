...
event12 = Event.create!(title: "Lenny Kravitz", date: "2024-11-23", location: "Rua Palestra Itália 200, São Paulo", description: "O escritor, produtor, multi-instrumentista vencedor de quatro prêmios GRAMMY, Lenny Kravitz, anuncia seu retorno ao Brasil com a inclusão de uma apresentação em São Paulo da turnê mundial Blue Electric Light Tour 2024. O show acontece no dia 23 de novembro, no Allianz Parque", user: user3)
